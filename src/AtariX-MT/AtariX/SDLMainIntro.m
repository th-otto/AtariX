/*   SDLMainIntro.m - main entry point for our Cocoa-ized SDL app
...
#if 0
// das ist in SDL 2.03 nach SDL_cococaevents.m gewandert
...
/*-(void)*/ /*static*/ void showPreferencesWindow(void)
{
	static PreferencesWindowController *w = NULL;

	if (!w)
	{
//		[[PreferencesWindowController alloc] init];
		w = [[PreferencesWindowController alloc] init];
	}
 }
...
#if SDL_USE_NIB_FILE
	// ist leider nötig, damit wir die "action"-Dinger kriegen?!?
